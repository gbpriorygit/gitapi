...
<style>
    body{
        background-image:linear-gradient(rgba(0,0,0,0.1),rgba(0,0,0,0.1)),  url("<?php echo URL; ?>assets/img/bg_6.jpg");
    ...
    .nav-pills.nav-pills-warning>li.active>a, .nav-pills.nav-pills-warning>li.active>a:focus, .nav-pills.nav-pills-warning>li.active>a:hover {background: transparent!important}
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 ml-auto mr-auto text-center">
                            <ul style="max-width: fit-content;" class="navButtons card nav nav-pills nav-pills-warning nav-pills-icons justify-content-center" role="tablist">
                                <li class="nav-item active  animationbtn1 navBtnLeft">
                                ...
                                <li class="nav-item  navBtnShadow">
                                    <a class="nav-link pageButtons" href="createUser" role="tablist">
                                ...
                                <div class="card-content table-responsive">
                                    <table class="table" id="tabl">
                                        <thead >
                                            <th></th>
                                            <th>Name <br>
                                                <input type="text" id="inpu" onkeyup="filterTabl()" class=""></th>
                                            <th>Role</th>
                                            <!-- <th>Supervisor</th> -->
                                            <th><center></center></th>
                                            ...
                                            <?php
                                                ...
                                                foreach ($users as $user) {
                                                    $output.='<tr>
                                                                ...
                                                                <td>'.$this->model->resultLogo($user->user_id).'</td>
            ...
            <script type="text/javascript">
                $('.resultNav').addClass('animationbtn');
