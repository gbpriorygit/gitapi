...
<style>
    body{
        background-image:linear-gradient(rgba(0,0,0,0.1),rgba(0,0,0,0.1)),  url("<?php echo URL; ?>assets/img/porche.jpg");
                                      ...
                                      <tbody>
                                          <?php
                                              ...
                                              foreach ($users as $user) {
                                                if ($user->role!='admin' && $user->role!='manager' && $user->role!='crmmanager') {
                                                  $output.='<tr>
