                                ...
                                <div class="card-content table-responsive box-outer">
                                    ...
                                    <table class="table table-hover">
                                        <thead>
                                            ...
                                            <th><strong><a id="lasttask_" href="<?php
                                                $query['orderby'] = 'lasttask';
                                                $newget = http_build_query($query);
                                                echo URL; ?>?<?php echo $newget; ?>
                                              ">Task</a></strong>
                                            ...
                                            <th><strong>Assigned From</strong></br>
                                              <select data-placeholder=" "  class="cho" multiple name="assigned_from[]" id="assigned_from">
                                                  <!-- <option value='%'>All</option> -->
                                                  <!-- <option value='%'>&nbsp;</option> -->
                                                   <!-- | <?php //echo $this->model->countBy($assigned_to,$status,$source);?> -->
                                                  <?php
                    ...
                    $(".arrow").hover(
                        ...
                        function() {
                            ...
                            if ($(this).hasClass("arrow-right")) {
                                ...
                                box.animate({scrollLeft: 2000}, 800
                            )
                            } else {
                                console.log('im left');
                                x = ((box.width()));
