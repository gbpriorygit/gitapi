                                    ...
                                    <div class="row">
                                       ...
                                       <div class="col-sm-6">
                                           <div class="form-group label-floating">
                                             ...
                                             &nbsp;
                                             <a>
                                               <i style="cursor:pointer;" data-title="Mobile" title="Mobile"  onclick="sipCall('call-audio','<?='77'.$_SESSION['user_sip'].$lead->phone_number;?>','<?=$lead->lead_id;?>',$(this).data('title'));$(this).addClass('btn_call_clicked');" class="material-icons call_now_btn">call</i>
                                             </a>
                                             &nbsp;
                                             <a>
                                               <i style="cursor:pointer;" data-title="Office"  title="Office"  onclick="sipCall('call-audio','<?=$_SESSION['user_sip'].$lead->phone_number;?>','<?=$lead->lead_id;?>',$(this).data('title'));$(this).addClass('btn_call_clicked');" class="material-icons call_now_btn">call</i>
                                             </a>
                                             &nbsp;
                                             <a>
                                              <i style="cursor:pointer;" data-title="Random IT" title="Random IT" onclick="sipCall('call-audio','<?='99'.$lead->phone_number;?>','<?=$lead->lead_id;?>',$(this).data('title'));$(this).addClass('btn_call_clicked');" class="material-icons call_now_btn">call</i>
                                             </a>
                                             &nbsp;
                                             <a>
                                               <i style="cursor:pointer;" data-title="Random UK" title="Random UK" onclick="sipCall('call-audio','<?='88'.$lead->phone_number;?>','<?=$lead->lead_id;?>',$(this).data('title'));$(this).addClass('btn_call_clicked');" class="material-icons call_now_btn">call</i>
                                             </a>
                                             &nbsp;
                                             <a>
                                               <i style="cursor:pointer;" data-title="Mobile Random" title="Mobile Random" onclick="sipCall('call-audio','<?='66'.$lead->phone_number;?>','<?=$lead->lead_id;?>',$(this).data('title'));$(this).addClass('btn_call_clicked');" class="material-icons call_now_btn">call</i>
                                             </a>
                                             &nbsp;
                                             <a>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group label-floating">
                                                ...
                                                <input type="text" name="alt_number" disabled  value="<?=$lead->alt_number;?>" class="form-control pna">
                                                <a target="_blank" href="https://web.whatsapp.com/send?phone=<?=$lead->alt_number;?>&amp;text=&amp;source=&amp;data=">
                                                  <img  src="<?php echo URL; ?>assets/img/wp-logo.png" style="width:30px;height:30px" alt="WhatsApp"/>
                                                </a>
                                                <a  href="viber://chat?number=<?=$lead->alt_number;?>">
                                                  <img  src="<?php echo URL; ?>assets/img/viber-logo.png" style="width:50px;height:50px" alt="Viber"/>
                                                </a>
                                                <a>
                                                <i style="cursor:pointer;" onclick="$('.pni').val($('.pna').val());$('#send_sms_modal').modal();" class="material-icons">textsms</i>
                                              </a>
                                              &nbsp;
                                              <a>
                                      ...
                                      <?php foreach ($evolutions as $evolution): ?>
                                        <div class="panel panel-info">
                                          <div class="panel-heading"><?=date("H:i d-m-Y", strtotime($evolution->date))?>
                                            <p class="category pull-right">
                                              <?php if ($evolution->user_id==$_SESSION['user_id']): ?>
