    ...
    public function getCallLog(){
      ...
      return $query->fetchAll();
        ...
        public function getEvents($lead_id){
          ...
          public function setSeenCustomer1MonthReminder($Customer1MonthReminder_id){
            $sql="UPDATE Customer1MonthReminder set seen=1 where Customer1MonthReminder_id=:Customer1MonthReminder_id";
            $query=$this->db->prepare($sql);
            $query->execute(array('Customer1MonthReminder_id'=>$Customer1MonthReminder_id));
          }
...
//////////////////////////////////////////////////////////
    ...
    public function editLead($lead_id){
      ...
      $old_c=$query->fetch(PDO::FETCH_ASSOC);
        ...
        $sql="UPDATE leads SET first_name=:first_name,last_name=:last_name,email=:email,source=:source,brand=:brand,phone_number=:phone_number,assigned_to=:assigned_to,note=:note,status=:status,alt_number=:alt_number,data_sheets=:data_sheets WHERE lead_id=:lead_id";
        $query = $this->db->prepare($sql);
