...
<style>
    body{
         background-image:linear-gradient(rgba(0,0,0,0.1),rgba(0,0,0,0.1)),  url("<?php echo URL; ?>assets/img/bg_phoenix.jpg");
...
$("#calendar").fullCalendar({
   timeZone: 'local',
    ...
    events: {
        ...
        url:'<?=URL?>api/getRemindersTeamleader',
        type: 'POST',
        allDay: false,
    }
});
