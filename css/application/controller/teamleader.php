...
if($_SESSION['role']!='teamleader') { header('Location:'.URL); return; };
/**
...
class teamleader extends Controller
{
    ...
    public function call_log(){
        ...
        require APP . 'view/teamleader/header.php';
        require APP . 'view/teamleader/call_log.php';
        require APP . 'view/teamleader/footer.php';
    }

    public function links($link){
        require APP . 'view/teamleader/header.php';
        require APP . 'view/teamleader/links/'.$link.'.php';
        require APP . 'view/teamleader/footer.php';
    }
    function leads(){
        ...
        require APP . 'view/teamleader/header.php';
        require APP . 'view/teamleader/leads.php';
        require APP . 'view/teamleader/footer.php';
    }
    ...
    function recycle(){
        ...
        require APP . 'view/teamleader/header.php';
        require APP . 'view/teamleader/recycle.php';
        require APP . 'view/teamleader/footer.php';
    }
    ...
    public function createLead(){
        ...
        require APP . 'view/teamleader/header.php';
        require APP . 'view/teamleader/createLead.php';
        require APP . 'view/teamleader/footer.php';
    }
    ...
    public function reminders(){
        ...
        require APP . 'view/teamleader/header.php';
        require APP . 'view/teamleader/reminders.php';
        require APP . 'view/teamleader/footer.php';
    }
    ...
    public function editLead($lead_id){
        ...
        $statuses=$this->model->getStatuses();
        require APP . 'view/teamleader/header.php';
        require APP . 'view/teamleader/editLead.php';
        require APP . 'view/teamleader/footer.php';
    }
    ...
    public function viewLead($lead_id){
        ...
        //$campaigns=$this->model->getCampaigns();
        require APP . 'view/teamleader/header.php';
        require APP . 'view/teamleader/viewLead.php';
        require APP . 'view/teamleader/footer.php';
    }
    ...
    public function calendar(){
        //$tasks        =  $this->model->getAllTasksAdmin();
        require APP . 'view/teamleader/header.php';
        require APP . 'view/teamleader/calendar.php';
        require APP . 'view/teamleader/footer.php';
    }

    public function agenda(){
        require APP . 'view/teamleader/header.php';
        require APP . 'view/teamleader/agenda.php';
        require APP . 'view/teamleader/footer.php';
    }
    ...
    public function activity(){
        ...
        //$tasks        =  $this->model->getAllTasksAdmin();
        require APP . 'view/teamleader/header.php';
        require APP . 'view/teamleader/activity.php';
        require APP . 'view/teamleader/footer.php';
    }
    ...
    public function profile(){
        require APP . 'view/teamleader/header.php';
        require APP . 'view/teamleader/profile.php';
        require APP . 'view/teamleader/footer.php';
    }
    ...
    public function users(){
        ...
        require APP . 'view/teamleader/header.php';
        require APP . 'view/teamleader/users.php';
        require APP . 'view/teamleader/footer.php';
        return;
    ...
    public function inactiveUsers($showHours=false,$date=null){
        if ($showHours=='workhours') {
            ...
            require APP . 'view/teamleader/header.php';
            require APP . 'view/teamleader/workhours.php';
            require APP . 'view/teamleader/footer.php';
            return;
        }elseif(!$showHours){
            $users=$this->model->getInactiveUsers();
    ...
    public function viewUser($user_id){
        ...
        require APP . 'view/teamleader/header.php';
        require APP . 'view/teamleader/viewUser.php';
        require APP . 'view/teamleader/footer.php';
    ...
    public function createUser(){
        ...
        require APP . 'view/teamleader/header.php';
        require APP . 'view/teamleader/createUser.php';
        require APP . 'view/teamleader/footer.php';
    }
    ...
    public function editUser($user_id){
        ...
        if(!isset($user->user_id)){
            ...
            require APP . 'view/teamleader/editUser.php';
        }
        require APP . 'view/teamleader/footer.php';
    }
    ...
    public function lists(){
        ...
        require APP . 'view/teamleader/header.php';
        require APP . 'view/teamleader/lists.php';
        require APP . 'view/teamleader/footer.php';
    }
    ...
    public function createList(){
        ...
        require APP . 'view/teamleader/header.php';
        require APP . 'view/teamleader/createList.php';
        require APP . 'view/teamleader/footer.php';
    }
    public function uploadLeads($list_id){
        ...
        require APP . 'view/teamleader/header.php';
        require APP . 'view/teamleader/uploadLeads.php';
        require APP . 'view/teamleader/footer.php';
    }
////////////////////////////////////////////////////////
    ...
    public function statuses(){
        $statuses=$this->model->getStatuses();
        require APP . 'view/teamleader/header.php';
        require APP . 'view/teamleader/statuses.php';
        require APP . 'view/teamleader/footer.php';
    }
    ...
    public function createStatus(){
        ...
        require APP . 'view/teamleader/header.php';
        require APP . 'view/teamleader/createStatus.php';
        require APP . 'view/teamleader/footer.php';
    }
    ...
    public function editStatus($status_id){
        ...
        if(!isset($status->status_id)){
            ...
            require APP . 'view/teamleader/editStatus.php';
        }
        require APP . 'view/teamleader/footer.php';
    }
//////////////////////////////////////////////////////////////
    ...
    public function editCampaign($campaign_id){
        ...
        if(!isset($campaign->campaign_id)){
            ...
            require APP . 'view/teamleader/editCampaign.php';
        }
        require APP . 'view/teamleader/footer.php';
    }
//////////////////////////////////////////////////////////////
