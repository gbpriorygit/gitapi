                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group label-floating">
                                              ...
                                              &nbsp;
                                              <a>
                                                <i style="cursor:pointer;" title="Mobile UK"  onclick="sipCall('call-audio','<?='78'.$_SESSION['user_sip'].$lead->phone_number;?>','<?=$lead->lead_id;?>');" class="material-icons call_now_btn">call</i>
                                              </a>
                                              &nbsp;
                                              <a>
