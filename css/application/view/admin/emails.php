...
<style>
    ...
    #main .message-list li .col-1 .title1 {
        position: absolute;
        top: 0;
        left: 0;
        text-overflow: ellipsis;
    ...
    #message {
        ...
        border-left: 0.1px outset #969595;
    }
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                    ...
                    <div id="main-nano-wrapper" class="nano">
                        <div class="nano-content">
                            <ul class="message-list">
                                <li class="unread" style="background: linear-gradient(to left, #1e3c72, #2a5298);display: flex;align-items: baseline;padding-left: 6px;border-radius: 3px;color: white;margin-bottom:10px;">
                                  <div class="" style="width: 15%; padding-left:50px">
                                    User
                                  </div>
                                ...
                                <li class="unread" style="display: flex; align-items: baseline;">
                                    <div class="" style="width: 15%;display: flex;align-items: baseline;">
                                        <i style="margin-right:15px;color: #fdfdfd;" class="fas fa-envelope-open-text"></i>  <p class="title"><?=$this->model->UserLogo($email->user_id)?></p>
                                    </div>
                                    <div class="" style="width: 15%;">
                                        <p onclick="quickViewEmail(<?=$email->id?>)" class="title1 select_me"><?=$email->client_name?></p>
                                    </div>
                                    <div class="" style="width: 25%;">
                                        <p class="title1"><?=$email->client_email?></p>
                                    </div>
                                    <div class="" style="width: 45%;margin-right: auto;display: flex;justify-content: space-between;">
                                        <div class="subject"><?=$email->subject?></div>
                                        <div class="date" style="padding-right: 30px;"><?=$email->time?></div>
                                    </div>
                                </li>
                                <hr style="margin: 7px 0;border-color: #eadcbf82;">
                                <?php endforeach;?>
                            </ul>
                        </div>
                    </div>
                ...
                <div id="message">
                    <div class="header">
                        <h1 class="page-title"><a onclick="$('body').removeClass('show-message')" class="icon circle-icon glyphicon glyphicon-chevron-left trigger-message-close"></a>Email</h1>
                    </div>
                        ...
                        <div class="nano-content">
                            <ul class="message-container">
                                <li class="sent">
                                    <div class="details">
                                        <div class="left">
                                           To: <div  class="arrow"></div><span id="client_name1"></span>
                                        </div>
                                        <div id="sent_time" class="right"></div>
                                    </div>
                                    <div class="message" style="color: black">
                                        ...
                                        <div class="at-reward-card">
                                            <div class="at-reward-card__header">
                                                <img class="socialImg at-reward-card__thumbnail" src="<?php echo URL; ?>assets/img/email_icon.png" style="width:auto;height:150px" alt="WhatsApp"/>

                                            </div>
                                            <div class="at-reward-card__content" style="padding: 0 20px">
                                                <br>
                                                <h2 id="client_subject"></h2>
                                                <br>
...
<script type="text/javascript">
    $('.mailNav').addClass('animationbtn');


    function quickViewEmail(id){

        $('body').addClass("show-message");
        $.ajax({
            url: '<?=URL?>api/quickViewEmail/'+id,
            type: 'get',
            success: function(data){
                var leadData = JSON.parse(data);
                console.log(id);
                console.log(leadData);
                document.getElementById("client_name1").textContent=leadData[0].client_name;
                // document.getElementById("client_name1").textContent=leadData[0].client_name;
                document.getElementById("sent_time").textContent=leadData[0].time;
                // document.getElementById("client_email").textContent=leadData[0].client_email;
                document.getElementById("client_subject").textContent=leadData[0].subject;
                document.getElementById("client_message").innerHTML=leadData[0].message;
