...
<style>
    body{
        background-image:linear-gradient(rgba(0,0,0,0.1),rgba(0,0,0,0.1)),  url("<?php echo URL; ?>assets/img/bgtoro.jpg");
    }
</style>
                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-md-6 ml-auto mr-auto text-center">
                            <ul style="max-width: fit-content;" class="navButtons max-width: fit-content; card nav nav-pills nav-pills-warning nav-pills-icons justify-content-center" role="tablist">
                                <li class="nav-item navBtnShadow navBtnLeft">
                                      <a class="nav-link pageButtons" href="createList" role="tablist">
                                          <i class="material-icons">add</i>
                                          New List
                                      </a>
                                </li>
                                <li class="nav-item navBtnShadow">
                                      <a class="nav-link pageButtons" href="<?=URL.$_SESSION['role'].'/createLead';?>" role="tablist">
                                          <i class="material-icons">add</i>
                                          New Lead
                                      </a>
                                </li>
                                        ...
                                        <tbody>
                                            <?php
                                                ...
                                                foreach ($lists as $list) {
                                                    ...
                                                    $output.='<tr>
                                                                <td><a href="'.URL.$_SESSION['role'].'/leads/?list_id='.$list->list_id.'">'.$list->list_name.'</a>&nbsp;<i onclick="editListName('.$list->list_id.',\''.$list->list_name.'\')"  class="material-icons">edit</i></td>
