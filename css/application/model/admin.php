...
//////////////////////////////////////////////////////////////////
    ...
    public function resultLogo($user_id){
        if ($user_id==14){
            return '<img style="width:50px" src="'.URL.'assets/img/ftd_icon.png">';
        }
        else if ($user_id==18){
            return '<img style="width:50px" src="'.URL.'assets/img/not_interested.png">';
        }

        else if ($user_id==24){
            return '<img style="width:50px" src="'.URL.'assets/img/wrong_icon.png">';
        }
        else if ($user_id==26){
            return '<img style="width:50px" src="'.URL.'assets/img/no_answer.png">';
        }

        else if ($user_id==27){
            return '<img style="width:50px" src="'.URL.'assets/img/deleted_icon.png">';
        }
        else if ($user_id==96){
            return '<img style="width:75px" src="'.URL.'assets/img/promo_logo.png">';
        }
        else{
            return '<img style="width:50px" src="'.URL.'assets/img/logout.png">';
        }
    }
    ...
    public function UserLogo($user_id){
        if ($user_id==20){
            return '<img style="width:80px" src="'.URL.'assets/img/admin_logo.png">';
        }
        else if ($user_id==7){
            return '<img style="width:80px" src="'.URL.'assets/img/dalia_logo.png">';
        }

        else if ($user_id==9){
            return '<img style="width:80px" src="'.URL.'assets/img/roslyn_logo.png">';
        }
        else if ($user_id==12){
            return '<img style="width:80px" src="'.URL.'assets/img/isaac_logo.png">';
        }

        else if ($user_id==31){
            return '<img style="width:80px" src="'.URL.'assets/img/davide_logo.png">';
        }
        else if ($user_id==52){
            return '<img style="width:80px" src="'.URL.'assets/img/endre_logo.png">';
        }

        else if ($user_id==98){
            return '<img style="width:80px" src="'.URL.'assets/img/elias_logo.png">';
        }

        else if ($user_id==100){
            return '<img style="width:80px" src="'.URL.'assets/img/grace_logo.png">';
        }

        else if ($user_id==101){
            return '<img style="width:80px" src="'.URL.'assets/img/eliott_logo.png">';
        }
        else if ($user_id==102){
            return '<img style="width:80px" src="'.URL.'assets/img/nicole_logo.png">';
        }
        else{
            return '<img style="width:80px" src="'.URL.'assets/img/double_logo.png">';
        }
    }


    public function RoleLogo($user_id){
        if ($user_id==='admin'){
            return '<img style="width:150px" src="'.URL.'assets/img/admin_badge.png">';
        }
        else if ($user_id=='crmmanager'){
            return '<img style="width:150px" src="'.URL.'assets/img/manager_badge.png">';
        }

        else if ($user_id=='manager'){
            return '<img style="width:150px" src="'.URL.'assets/img/manager_badge.png">';
        }

        else if ($user_id=='operator'){
            return '<img style="width:150px" src="'.URL.'assets/img/operator_badge.png">';
        }
        else if ($user_id=='customer'){
            return '<img style="width:150px" src="'.URL.'assets/img/customer_badge.png">';
        }
    ...
    public function user_tab($user){
        if ($user->user_id==7){
            return '<button style="color: white; " class="btn daliabtn agent_btn">'.$user->username.'</button>';
        }

        else if ($user->user_id==9){
            return '<button style="color: white; " class="btn roslynbtn agent_btn">'.$user->username.'</button>';
        }
        else if ($user->user_id==12){
            return '<button style="color: white; " class="btn isaacbtn agent_btn">'.$user->username.'</button>';
        }

        else if ($user->user_id==31){
            return '<button style="color: white; " class="btn davidebtn agent_btn">'.$user->username.'</button>';
        }
        else if ($user->user_id==52){
            return '<button style="color: white; " class="btn endrebtn agent_btn">'.$user->username.'</button>';
        }

        else if ($user->user_id==98){
            return '<button style="color: white; " class="btn eliasbtn agent_btn">'.$user->username.'</button>';
        }

        else if ($user->user_id==101){
            return '<button style="color: white; " class="btn eliottbtn agent_btn">'.$user->username.'</button>';
        }

        else if ($user->user_id==102){
            return '<button style="color: white; " class="btn nicolebtn agent_btn">'.$user->username.'</button>';
        }

        else if ($user->user_id==100){
            return '<button style="color: white; " class="btn gracebtn agent_btn">'.$user->username.'</button>';
        }
    ...
    public function getRemindersAdmin($lead_id){
...
//      $sql="SELECT * FROM access_logs order by log_time desc limit 200";
//      $query=$this->db->prepare($sql);
//      $query->execute();
//      return $query->fetchAll();
//    }
    ...
    public function getCallLog(){
        ...
        if (isset($_POST['apertura'])) {
            $test_final = $_POST['apertura'];
            $userQuery = 'AND call_log.user_id = "'.$test_final.'"';
        }
        else {
            $userQuery = '';
        }
        ...
        if(isset($_POST['log_time'])) {
            ...
            $time = explode(' - ', $_POST['log_time']);
            $log_start=date("Y-m-d", strtotime($time[0]));
            $log_end=date("Y-m-d", strtotime($time[1]));
            $timeQuery = 'AND (call_log.calltime BETWEEN "'.$log_start.'" AND "'.$log_end.'")';
        }
        else {
            $timeQuery = '';
        }
        ...
        WHERE (call_log.lead_id > 0) '.$userQuery.' '.$timeQuery.' 
        order by calltime desc limit 400';
        $query=$this->db->prepare($sql);
        $query->execute();
        return $query->fetchAll();
    }
    ...
    public function getActivity_log(){

        if (isset($_POST['apertura'])) {
            $test_final = $_POST['apertura'];
            $userQuery = 'AND log.user_id = "'.$test_final.'"';
        }
        else {
            $userQuery = '';
        }
        ...
        if(isset($_POST['log_time'])) {
            ...
            $log_start=date("Y-m-d", strtotime($time[0]));
            $log_end=date("Y-m-d", strtotime($time[1]));
            $timeQuery = 'AND (log.date BETWEEN "'.$log_start.'" AND "'.$log_end.'")';
        }
        else {
            $timeQuery = '';
        }
        ...
        $sql='SELECT * FROM log 
        WHERE (log.lead_id > 0) '.$userQuery.' '.$timeQuery.' 
        order by log.date desc limit 400';
        $query=$this->db->prepare($sql);
        $query->execute();
        return $query->fetchAll();
    }
...
//    }
    ...
    public function createUser(){
        ...
        $sql="INSERT INTO users(username,password,first_name,last_name,role,supervisor,recycle,user_email,user_sip) VALUES (:username,:password,:first_name,:last_name,:role,:supervisor,:recycle,:user_email,:user_sip)";
        $query = $this->db->prepare($sql);
    ...
    public function editUser($user_id){
        ...
        $pwdd="SELECT password FROM users WHERE user_id=:user_id";
        $pwd = $this->db->prepare($pwdd);
        $pwd->execute(array('user_id' =>$user_id));
        $pwd2 = $pwd->fetch();

        $sql="UPDATE users SET username=:username,password=:password,first_name=:first_name,last_name=:last_name,role=:role,recycle=:recycle,user_email=:user_email,user_sip=:user_sip,supervisor=:supervisor,show_fop=:show_fop WHERE user_id=:user_id";
        $query = $this->db->prepare($sql);
        $parameters=array(':username' => $_POST['username'],
            ':password' => $_POST['password'],
            ':first_name' => $_POST['first_name'],
        ...
        if ($pwd2->password === $_POST['password']) {

        }
        else{
            $current_session_id = session_id();

            $sql3="SELECT *  FROM user_sessions WHERE user_id=$user_id";
            $query3 = $this->db->prepare($sql3);
            $query3->execute();

            foreach ($query3 as $quer){

                $session_id_to_destroy = $quer->session_id;
                session_id($session_id_to_destroy);
                session_start();
                session_destroy();

                $sql3="DELETE FROM user_sessions WHERE id=$quer->id";
                $query3 = $this->db->prepare($sql3);
                $query3->execute();
    ...
    public function resetAssignedTo($lead_id){
        $sql="UPDATE leads SET assigned_to=1 AND status=15 WHERE lead_id=:lead_id";
        $query=$this->db->prepare($sql);
...
///////////////////////////////////////////////////////////////////
    ...
    public function getStatusess(){
        $sql='SELECT status_id, status_name as c FROM status WHERE status_id IN (8,9,11,13)';
        $query = $this->db->prepare($sql);
        $query->execute();
    ...
    public function getSources(){
        $sql='SELECT source, count(lead_id) as c FROM leads
                LEFT JOIN users  ON users.user_id = leads.assigned_to
                where (users.recycle =0 OR leads.assigned_to=0)
                GROUP BY source';
        $query = $this->db->prepare($sql);
        $query->execute();
        return $query->fetchAll(PDO::FETCH_ASSOC);
    ...
    public function getAssignedTo(){
        $sql='SELECT users.user_id, users.username, count(lead_id) as c FROM leads
                LEFT JOIN users  ON users.user_id = leads.assigned_to
                where (users.recycle =0)
                GROUP BY assigned_to
                ORDER BY users.orderer';
        $query = $this->db->prepare($sql);
        $query->execute();
        return $query->fetchAll(PDO::FETCH_ASSOC);
    }

    public function getReports($source=null){

        if ($source) {
            $sourceQuery = 'AND leads.source=' . '"'.$source.'"';
        }
        else {
            $sourceQuery = '';
        }

        $sql='SELECT users.username,status.status_name,
                COUNT(CASE WHEN leads.status = 1 THEN 1 ELSE NULL END) AS "R-New",
                COUNT(CASE WHEN leads.status = 3 THEN 1 ELSE NULL END) AS Low,
                COUNT(CASE WHEN leads.status = 4 THEN 1 ELSE NULL END) AS Mid,
                COUNT(CASE WHEN leads.status = 5 THEN 1 ELSE NULL END) AS High,
                COUNT(CASE WHEN leads.status = 6 THEN 1 ELSE NULL END) AS Stock,
                COUNT(CASE WHEN leads.status = 7 THEN 1 ELSE NULL END) AS "No answer",
                COUNT(CASE WHEN leads.status = 8 THEN 1 ELSE NULL END) AS "Inactive N.A",
                COUNT(CASE WHEN leads.status = 9 THEN 1 ELSE NULL END) AS FTD,
                COUNT(CASE WHEN leads.status = 10 THEN 1 ELSE NULL END) AS "Existing Clients",
                COUNT(CASE WHEN leads.status = 11 THEN 1 ELSE NULL END) AS "Wrong Person",
                COUNT(CASE WHEN leads.status = 13 THEN 1 ELSE NULL END) AS "Inactive N.I",
                COUNT(CASE WHEN leads.status = 14 THEN 1 ELSE NULL END) AS Attempting,
                COUNT(CASE WHEN leads.status = 15 THEN 1 ELSE NULL END) AS Promo
                FROM leads
                LEFT JOIN users ON leads.assigned_to = users.user_id
                LEFT JOIN status ON leads.status = status.status_id
                WHERE (users.recycle =0 '.$sourceQuery.' AND leads.assigned_to!=0 AND leads.assigned_to!=1 AND leads.assigned_to!=14 AND leads.assigned_to!=37 AND leads.assigned_to!=67 AND leads.assigned_to!=96) 
        GROUP BY username';

//        $sql='SELECT users.username,status.status_name, COUNT(leads.status) AS c FROM leads LEFT JOIN users ON leads.assigned_to = users.user_id
//        LEFT JOIN status ON leads.status = status.status_id
//        WHERE (users.recycle =0 AND leads.source="Promo" AND leads.assigned_to!=0 AND leads.assigned_to!=1 AND leads.assigned_to!=14 AND leads.assigned_to!=37 AND leads.assigned_to!=67 AND leads.assigned_to!=96) GROUP BY username,status';
        $query = $this->db->prepare($sql);
        $query->execute();
        return $query->fetchAll(PDO::FETCH_ASSOC);
    }
    ...
    public function getRnew($assigned=null){

        if ($assigned) {
            $assignedQuery = 'AND new_leads.assigned_to = '.$assigned;
        }
        else {
            $assignedQuery = '';
        }
        ...
        if(isset($_POST['log_time'])) {
            ...
            $log_start=date("Y-m-d", strtotime($time[0]));
            $log_end=date("Y-m-d", strtotime($time[1]));
            $timeQuery = 'AND (new_leads.time BETWEEN "'.$log_start.'" AND "'.$log_end.'")';
        }
        else {
            $timeQuery = '';
        }
        ...
        $sql='SELECT date(time) AS d,
        COUNT(CASE WHEN leads.source ="Promo" THEN 1 ELSE NULL END) AS "Promo",
        COUNT(CASE WHEN leads.source ="Black Panther" THEN 1 ELSE NULL END) AS "Black Panther",
        COUNT(CASE WHEN leads.source ="Marketing" THEN 1 ELSE NULL END) AS "Marketing",
        COUNT(CASE WHEN leads.source ="BeTrader" THEN 1 ELSE NULL END) AS "BeTrader",
        COUNT(CASE WHEN leads.source ="ExTrader" THEN 1 ELSE NULL END) AS "ExTrader",
        COUNT(CASE WHEN leads.source ="Investing" THEN 1 ELSE NULL END) AS "Investing",
        COUNT(CASE WHEN leads.source ="Robot" THEN 1 ELSE NULL END) AS "Robot",
        COUNT(CASE WHEN leads.source ="Test" THEN 1 ELSE NULL END) AS "Test",
        COUNT(CASE WHEN leads.source ="Leverate" THEN 1 ELSE NULL END) AS "Leverate",
        COUNT(CASE WHEN leads.source ="Trader" THEN 1 ELSE NULL END) AS "Trader",
        COUNT(CASE WHEN leads.source ="CPA" THEN 1 ELSE NULL END) AS "CPA",
        COUNT(CASE WHEN leads.source ="SMS" THEN 1 ELSE NULL END) AS "SMS"
        FROM new_leads 
        LEFT JOIN users ON new_leads.assigned_to = users.user_id 
        LEFT JOIN leads ON new_leads.lead_id = leads.lead_id
        WHERE (users.recycle =0) '.$assignedQuery.' '.$timeQuery.'
        GROUP BY date(time)';
        $query = $this->db->prepare($sql);
        $query->execute();
        return $query->fetchAll(PDO::FETCH_ASSOC);
    ...
    public function getExportReports($source){

        if ($source) {
            $sourceQuery = 'AND leads.source=' . '"'.str_replace('_',' ',$source).'"';
        }
        else {
            $sourceQuery = '';
        }
    ...
    public function getRnewExport($id){
...
//        }
        ...
        LEFT JOIN users ON new_leads.assigned_to = users.user_id 
        LEFT JOIN leads ON new_leads.lead_id = leads.lead_id
         WHERE new_leads.assigned_to = '.$id.'
        GROUP BY date(time)';
        $query = $this->db->prepare($sql);
        $query->execute();
        return $query->fetchAll(PDO::FETCH_ASSOC);
    ...
    public function get_recordssss($id) {


        $sql='SELECT date(time) AS d,
        COUNT(CASE WHEN leads_remove_report.status_id =8 THEN 1 ELSE NULL END) AS "Inactive N.A",
        COUNT(CASE WHEN leads_remove_report.status_id =9 THEN 1 ELSE NULL END) AS "FTD",
        COUNT(CASE WHEN leads_remove_report.status_id =11 THEN 1 ELSE NULL END) AS "Wrong Person/Number",
        COUNT(CASE WHEN leads_remove_report.status_id =13 THEN 1 ELSE NULL END) AS "Inactive N.I"
        FROM leads_remove_report 
        LEFT JOIN users ON leads_remove_report.user_id = users.user_id 
        LEFT JOIN status ON leads_remove_report.status_id = status.status_id
        WHERE leads_remove_report.user_id = '.$id.'
        GROUP BY date(time)';
        $query = $this->db->prepare($sql);
        $query->execute();
        return  $query->fetchAll(PDO::FETCH_ASSOC);
    ...
    public function getRemoveLeads($assigned=null){

        if ($assigned) {
            $assignedQuery = 'AND leads_remove_report.user_id = '.$assigned;
        }
        else {
            $assignedQuery = '';
        }
        ...
        if(isset($_POST['log_time'])) {
            ...
            $log_start=date("Y-m-d", strtotime($time[0]));
            $log_end=date("Y-m-d", strtotime($time[1]));
            $timeQuery = 'AND (leads_remove_report.time BETWEEN "'.$log_start.'" AND "'.$log_end.'")';
        }
        else {
            $timeQuery = '';
        }
    ...
    public function getPromo(){
        $sql='SELECT date(time) AS d, lead_send,
        COUNT(CASE WHEN leads_promo.assigned_to = 7 THEN 1 ELSE NULL END) AS "Dalia",
        COUNT(CASE WHEN leads_promo.assigned_to = 9 THEN 1 ELSE NULL END) AS "Rosslyn",
        COUNT(CASE WHEN leads_promo.assigned_to = 12 THEN 1 ELSE NULL END) AS "Isaac",
        COUNT(CASE WHEN leads_promo.assigned_to = 31 THEN 1 ELSE NULL END) AS "Davide",
        COUNT(CASE WHEN leads_promo.assigned_to = 52 THEN 1 ELSE NULL END) AS "Endre",
        COUNT(CASE WHEN leads_promo.assigned_to = 98 THEN 1 ELSE NULL END) AS "Elias",
        COUNT(CASE WHEN leads_promo.assigned_to = 100 THEN 1 ELSE NULL END) AS "Grace",
        COUNT(CASE WHEN leads_promo.assigned_to = 101 THEN 1 ELSE NULL END) AS "Eliott",
        COUNT(CASE WHEN leads_promo.assigned_to = 102 THEN 1 ELSE NULL END) AS "Nicole"
        FROM leads_promo 
        LEFT JOIN users ON leads_promo.assigned_to = users.user_id 
        WHERE (users.recycle =0) 
        GROUP BY date(time), lead_send';
        $query = $this->db->prepare($sql);
        $query->execute();
        return $query->fetchAll(PDO::FETCH_ASSOC);
    }

    public function getAccessLogs($user=null){

        if ($user) {
            $userQuery = 'AND access_logs.user_id = '.$user;
        }
        else {
            $userQuery = '';
        }
        ...
        if(isset($_POST['log_time'])) {
            ...
            $log_start=date("Y-m-d", strtotime($time[0]));
            $log_end=date("Y-m-d", strtotime($time[1]));
            $timeQuery = 'AND (access_logs.log_time BETWEEN "'.$log_start.'" AND "'.$log_end.'")';
        }
        else {
            $timeQuery = '';
        }

        $sql='SELECT log_time AS d, access_logs.type as access_type
        FROM access_logs 
        LEFT JOIN users ON access_logs.user_id = users.user_id 
        WHERE (users.recycle =0) '.$userQuery.' '.$timeQuery.' order by `log_time` desc';
        $query = $this->db->prepare($sql);
        $query->execute();
        $logs=$query->fetchAll(PDO::FETCH_ASSOC);
        $allArray=array();
        array_push($allArray, $logs);
        array_push($allArray, $sql);
        return $allArray;
    }
    ...
    public function getSourceNames(){
        $sql='SELECT source FROM leads
                LEFT JOIN users  ON users.user_id = leads.assigned_to
                where (users.recycle =0 OR leads.assigned_to=0)
                GROUP BY source';
        $query = $this->db->prepare($sql);
        $query->execute();
        $sources = $query->fetchAll(PDO::FETCH_NUM);
        $sourcesArr= array();
        foreach ($sources as $source){
            array_push($sourcesArr, $source);
        }
        return $sourcesArr;
    }
    ...
    public function countBy($user_id='%',$status_id='%',$source_id='%',$assigned_from='%'){
        ...
        $last_change   = (isset($_REQUEST['last_change'])?$_REQUEST['last_change']:'%');

        if ($last_change=='%' || $last_change=='') {
            $last_change='1970-01-01 - '.date("Y-m-d");
        }

//            $vars['last_change']='1970-01-01 - '.date("Y-m-d");
            $reg=explode(' - ',$last_change);
            $last_change_min=date("Y-m-d", strtotime($reg[0]));
            $last_change_max=date("Y-m-d", strtotime($reg[1]));

            $last_change_query=' AND (DATE(leads.last_change) >= DATE('.$last_change_min.') AND DATE(leads.last_change) <=DATE('.$last_change_max.')';



        $sql='SELECT count(lead_id) as c FROM leads
                LEFT JOIN users  ON users.user_id = leads.assigned_to
                where (users.recycle =0 OR leads.assigned_to=0) and source '.$source_ids1.' and status '.$status_ids1.' and assigned_to '.$user_ids1.' and assigned_from '.$assigned_froms1.'AND (DATE(leads.last_change) >= DATE("'.$last_change_min.'") AND DATE(leads.last_change) <=DATE("'.$last_change_max.'"))'
...
//        return $sql;
    ...
    public function countByStatus($status_id='%'){
        ...
        $sql="SELECT count(lead_id) as c FROM leads
                LEFT JOIN users  ON users.user_id = leads.assigned_to
                where (users.recycle =0 OR leads.assigned_to=0) AND status like :status_id";
        $query = $this->db->prepare($sql);
    ...
    public function countByStatusRecycle($status_id='%'){
        $sql="SELECT count(lead_id) as c FROM leads
                LEFT JOIN users  ON users.user_id = leads.assigned_to
                where (users.recycle =1) AND status like :status_id";
        $query = $this->db->prepare($sql);
        $query->execute(array(':status_id'=>$status_id));
        $c=$query->fetch();
        return $c->c;
    ...
    public function addAcademyNote($lead_id){
        $sql="INSERT INTO academy_comments(content,user_id,lead_id) VALUES(:content,:user_id,:lead_id)";
        $query = $this->db->prepare($sql);
        $parameters=array(
            ':content' => $_POST['content'],
            ':lead_id' => $_POST['lead_id'],
    ...
    public function getAcademyComments($lead_id){
        $sql='SELECT academy_comments.*,users.first_name,users.last_name FROM academy_comments LEFT JOIN users ON users.user_id = academy_comments.user_id where academy_comments.lead_id=:lead_id  order by `note_id` desc';
        $query = $this->db->prepare($sql);
        $query->execute(array(':lead_id'=>$lead_id));
        return $query->fetchAll();
    }
...
//////////////////////////////////////////////////////////////////////
    ...
    public function countListLeads($list_id){
        $sql="SELECT count(lead_id) as total FROM leads
                LEFT JOIN users  ON users.user_id = leads.assigned_to
                where (users.recycle =0 OR leads.assigned_to=0) AND list_id=:list_id";
        $query=$this->db->prepare($sql);
        $query->execute(array(':list_id' => $list_id));
        $r=$query->fetch();
        return $r->total;
    ...
    public function countListBy($recycle=0, $list=null, $status=null, $source=null, $assigned_to=null){
...
//        }
        ...
        if ($list) {
            $listQuery = 'AND leads.list_id=' . '"'.$list.'"';
        }
        else {
            $listQuery = '';
        }
        ...
        if ($status) {
            $statusQuery = 'AND leads.status=' . '"'.$status.'"';
        }
        else {
            $statusQuery = '';
        }
        if ($assigned_to) {
            $assignedToQuery = 'AND leads.assigned_to=' . '"'.$assigned_to.'"';
        }
        else {
            $assignedToQuery = '';
        }
        ...
        $sql='
                SELECT count(lead_id) as c FROM leads
                LEFT JOIN users  ON users.user_id = leads.assigned_to
                where (users.recycle ='.$recycle.' OR leads.assigned_to=0) '.$listQuery.' '.$sourceQuery.' '.$statusQuery.' ';///
        //print_r($sql);
        $query = $this->db->prepare($sql);
        $query->execute();
        $c=$query->fetch();
    ...
    public function countListRecycle($list_id){
        $sql="SELECT count(lead_id) as total FROM leads
                LEFT JOIN users  ON users.user_id = leads.assigned_to
                where (users.recycle =1) AND list_id=:list_id";
        $query=$this->db->prepare($sql);
        $query->execute(array(':list_id' => $list_id));
        $r=$query->fetch();
        return $r->total;
    ...
    public function getLists(){
        $sql='SELECT * FROM lists order by orderer asc';
        $query = $this->db->prepare($sql);
        $query->execute();
        return $query->fetchAll();
    }
        ...
        if (isset($_POST["import"])) {
            ...
            if ($_FILES["file"]["size"] > 0) {
                ...
                while (($column = fgetcsv($file, 50000, ",")) !== FALSE) {
                    ...
                    if ($twoNumbers==='39'){
                        $check_sql="SELECT count(lead_id) as total FROM leads WHERE phone_number=:phone_number AND assigned_to NOT IN (18,24,26,27)";
                    }
                    else{
                        if (!is_numeric($twoNumbers))
                        {
                            ...
                            $fullNr = '39' . $phoneNr;
                            $check_sql = "SELECT count(lead_id) as total FROM leads WHERE phone_number='$fullNr' AND assigned_to NOT IN (18,24,26,27)";
                        }
                    }
...
////////////////////////////////////////////////////
    ...
    public function fetchLeads($export){
        ...
        if (!isset($_REQUEST['search_'])) {//if filter
            ...
            $vars['list_id']        = (isset($_GET['list_id'])?$_GET['list_id']:'%');
        ...
        $vars['page']           = (int)(isset($_REQUEST['page'])? $_REQUEST['page']:0);
        $vars['orderby']    = (isset($_REQUEST['orderby'])?$_REQUEST['orderby']:'last_change');
...
//////////////////////////////////////////////////////////
        ...
        if (isset($_POST['allCheckedLeads'])){
            $allChecked = json_decode( $_POST['allCheckedLeads'] );

            if(!empty($allChecked) && array_filter($allChecked)){

//            print_r($_POST['allCheckedLeads']);
//            $noBrackets1=str_replace("[","", $allChecked);
//            $noBrackets2=str_replace("]","", $noBrackets1);
                $in = implode(',', $allChecked);
//            $in=str_repeat('?,', count($allChecked) - 1) . '?';
//            print_r($in);
                $checkedLeadsQuery="AND leads.lead_id IN (".$in.") ";
//            return $_POST['allCheckedLeads'];
//            error_log($checkedLeadsQuery);
            }
            else{
                $checkedLeadsQuery='';
            }
        ...
        if (!isset($_REQUEST['search_'])) {//if fitler
            $sql="SELECT ".$sel." FROM leads
                        ...
                        AND phone_number like  '%".$vars['phone_number']."%'
...
//              $this->exportLeads($leads);
    ...
    public function fetchRecycle($export){
...
//            error_log($checkedLeadsQuery);
    ...
    public function getRecycle1($export=null){
        ...
        $sql="SELECT leads.*,status.status_name,status.status_description,n.start as lasttask FROM leads
                        LEFT JOIN status ON status.status_id = leads.status
                        LEFT JOIN users  ON users.user_id = leads.assigned_to
                        LEFT JOIN tasks AS n ON n.task_id =
                             ( SELECT noq.task_id
                               FROM tasks AS noq
                               WHERE noq.lead_id = leads.lead_id

                               ORDER BY noq.task_id DESC
                               LIMIT 1
                             )
                        WHERE
                        (
    ...
    public function uploadDocuments(){
        ...
        $allow_ext = array('docx');//,'doc','docx','csv','xls','xlsx','txt','jpg','jpeg'
    ...
    public function uploadFile(){
        ...
        if (move_uploaded_file($_FILES["documents"]["tmp_name"],$target_file)) {
            $sql="INSERT INTO uploads(user_id,url) VALUES(:user_id,:url)";
            $query=$this->db->prepare($sql);
            $query->execute(array(':user_id' =>(int)$user_id,':url'=>$target_file));
            echo "success";
        }else{
        ...
        header("Location:".URL.$_SESSION['role'].'/upload/'.$user_id);
    }
    ...
    public function getUploads($user_id){
        $sql="SELECT * FROM uploads WHERE `user_id`=:user_id ORDER BY  document_id DESC";
        $query=$this->db->prepare($sql);
        $query->execute(array(':user_id' =>$user_id));
        $documents=$query->fetchAll();
        //header('Content-type: application/json');
