...
<script type="text/javascript">
    ...
    function sipCall(s_type,phone_number,lead_id,from_number) {
        ...
        $.ajax({
            ...
            type: 'POST',
            data:{phone_number:lead_id,from_number:from_number}
        }).done(function(data) {
            //console.log(data);
        });
    ...
    function uiBtnCallSetText(s_text) {
        switch (s_text) {
            case "Ready":
                {
                    $('.call_now_btn').removeClass('btn_call_clicked');
