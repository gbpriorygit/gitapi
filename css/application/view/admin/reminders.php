...
<style>
    body{
         background-image:linear-gradient(rgba(0,0,0,0.2),rgba(0,0,0,0.3)),  url("<?php echo URL; ?>assets/img/bg_11.jpg");
...
$('.reminderNav').addClass('animationbtn');
var date = new Date();
var d = date.getDate();
var m = date.getMonth();
