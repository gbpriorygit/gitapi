                                        ...
                                        <div class="form-group row m-b-30">
                                            <div class="col-md-6">
                                                ...
                                                <div  class="callIconsDiv">
                                                    ...
                                                    <a class="callIcons">
                                                        <img  src="<?php echo URL; ?>assets/img/phone0.png" data-toggle="tooltip" data-placement="top" class="callImg" alt="phone 1" title="Mobile" onclick="sipCall('call-audio','<?=$_SESSION['user_sip'].$_SESSION['user_sip'].$lead->phone_number;?>','<?=$lead->lead_id;?>');"/>
