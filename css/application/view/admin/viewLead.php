                ...
                <div class="card m-b-30">
                    <div class="card-body">
                        ...
                        <div class="text-center pb-3">
                            ...
                            <div class="col-md-6 pb-3"><button onclick="sipCall('call-audio','<?='62'.$lead->phone_number;?>','<?=$lead->lead_id;?>');" class="btn btn-block mb-2">Call</button> </div>
                        ...
                        <div class="card m-b-30">
                            <div class="card-body">
                                ...
                                <div class="row m-b-30">
                                    ...
                                    <div class="col-sm-12 pb-3 m-b-30">
                                        <label class="font-custom">Source: </label>
                                        <select name="mental" class="form-control '.$lead->lead_id.'" onchange="editSource('<?=$lead->lead_id;?>',this.value)" id="source_select">
                                            <option selected class="oldmental<?=$lead->lead_id;?>" value="<?=$lead->source;?>"><?=$lead->source;?></option>
                                    ...
                                    <div class="col-sm-12 pb-3">
                                        <label class="font-custom">Assign To: </label>
                                        <?php
                                        $output='';
                                        $st='';
                                        ...
                                        $output.='<td><select class=" form-control '.$lead->lead_id.'" onchange="editAssign('.$lead->lead_id.',Number(this.value))" id="assign_select"><option class="oldsassign'.$lead->lead_id.'" value="'.$lead->assigned_to.'">'.$this->model->getUser($lead->assigned_to)->first_name.'</option>'.$st.'</select></td>';
                                        echo $output;
                                        ?>
                                    </div>
                                </div>
                            ...
                            <div class="tab-content">
                                <div class="tab-pane" id="profile">
                                    <div class="row">
                                        <div class="col-sm-12  pb-3">
                                            ...
                                            <input type="text" disabled placeholder="Leave you note here" class="form-control form-control-custom" value="<?=$lead->note;?>" name="example-email">
                                        </div>
                                                ...
                                                <form class="form-horizontal form-material">
                                                    <div class="form-group row m-b-30">
                                                        <div class="col-md-6">
                                                            ...
                                                            <input type="text" placeholder="<?=$lead->phone_number;?>" onchange="editName('<?=$lead->lead_id;?>',this.value)"  class="form-control form-control-custom" value="<?=$lead->first_name;?>">
                                                        </div>
                                                        <div class="col-md-6">
                                                            <label class="font-custom">Last Name</label>
                                                            <input type="text"  placeholder="<?=$lead->last_name;?>" onchange="editSurname('<?=$lead->lead_id;?>',this.value)" class="form-control form-control-custom" value="<?=$lead->last_name;?>">
                                                        </div>
                                                    </div>
                                                    <?php if(!isset($_GET['modal'])){ ?>
                                                        <div class="form-group row m-b-30">
                                                            <div class="col-md-6">
                                                                ...
                                                                <input type="text"  placeholder="<?=$lead->phone_number;?>" onchange="editPhone('<?=$lead->lead_id;?>',this.value)" class="form-control form-control-custom" value="<?=$lead->phone_number;?>" id="example-email">
                                                            ...
                                                            <div class="col-md-6">
                                                                ...
                                                                <input type="text"  placeholder="Alt Number" onchange="editAltPhone('<?=$lead->lead_id;?>',this.value)" class="form-control form-control-custom" value="<?=$lead->alt_number;?>">
                                                                <div class="callIconsDiv">
                                                        ...
                                                        <div class="form-group row m-b-30">
                                                            <div class="col-md-6">
                                                                ...
                                                                <input type="text" onchange="editEmail('<?=$lead->lead_id;?>',this.value)" placeholder="<?=$lead->email;?>" class="form-control form-control-custom" value="<?=$lead->email;?>">
                                                                <div class="callIconsDiv">
                                ...
                                <div role="tabpanel" class="tab-pane" id="promo">
                                    ...
                                    <div class="col-md-12 ">
                                        ...
                                        <div class="col-sm-12 pb-3">
                                            <div class="form-group label-floating">
                                                <label class="control-label">VC Dial Description</label>
                                                <input type="text" rows="4" value="<?=$lead->data_sheets;?>" class="form-control"></input>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-12 pb-3">
                                            <div class="form-group label-floating">
                                                ...
                                                <input type="text" rows="4" value="<?=$lead->webform;?>" class="form-control"></input>
                                            </div>
                                        </div>
...
<script type="text/javascript">
    ...
    function editAssign(lead_id,assigned_to){
        swal({
            title: 'Are you sure?',
            text: "",
            type: 'warning',
    ...
    function editName(lead_id, name){
    ...
    function editSurname(lead_id, surname){
    ...
    function editPhone(lead_id, phone_number){
    ...
    function editAltPhone(lead_id, alt_number){

        console.log(alt_number);
        console.log('lead ', lead_id)
        swal({
            title: 'Are you sure?',
            text: "",
    ...
    function editEmail(lead_id, email){
    ...
    function editSource(lead_id,source){
        swal({
            title: 'Are you sure?',
            text: "",
            type: 'warning',
    ...
    function editAssignedTo(lead_id,assigned_to){
        swal({
            title: 'Are you sure?',
            text: "",
            type: 'warning',
