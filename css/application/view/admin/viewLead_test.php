...
<style>
    ...
    body{ background-image: linear-gradient(rgba(0,0,0,0.1) , rgba(0,0,0,0.2) ), url("../../assets/img/bg_16.jpg");
        ...
        <div class="row">
            <form method="POST" action="">
                                        ...
                                        <div role="tabpanel" class="tab-pane" id="profile">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group label-floating">
                                                    ...
                                                    <td>
                                                        <select name="mental" class="cho form-control sss'.$lead->lead_id.'" onchange="editSource('<?=$lead->lead_id;?>',this.value)" id="source_select">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group label-floating">
                                                    ...
                                                    $output.='<td><select class="cho form-control ss'.$lead->lead_id.'" onchange="editAssign('.$lead->lead_id.',Number(this.value))" id="assign_select"><option class="oldsassign'.$lead->lead_id.'" value="'.$lead->assigned_to.'">'.$this->model->getUser($lead->assigned_to)->first_name.'</option>'.$st.'</select></td>';
                                                    echo $output;
                                                    ?>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group label-floating">
                                                    ...
                                                    <input type="text" disabled   value="<?=$lead->webform;?>" class="form-control">
                                                </div>
                                            </div>
                ...
                <div class="col-sm-12">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <a href="../editLead/<?=$lead->lead_id;?>" class="submit-btn btn btn-warning animationbtn1  pull-right">Edit</a>
        ...
        <div class="modal-content" style="height:200px">
            <div class="modal-body">
                <form class="" action="" method="post">
                    ...
                    <?php $color= array('Betrader' => '#bdc3c7','Facebook'=>'#1c7ce0','Cpa'=>'#FCF6BA','Leverate'=>'#CB7F3C','Marketing'=>'#56488c','Promo'=>'#2c4e60','Sms'=>'#1e130c','Black panther'=>'#434343'); ?>
                    <input type="hidden" value="<?=$color[$lead->source]?>" name="color">
