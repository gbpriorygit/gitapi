...
<style>
    body{
        background-image:linear-gradient(rgba(0,0,0,0.5),rgba(0,0,0,0.3)),  url("<?php echo URL; ?>assets/img/bglion.jpg");
    }
</style>
                                        ...
                                        <tbody>
                                          <?php
                                              ...
                                              foreach ($users as $user) {
                                                if ($user->role!='admin' && $user->role!='manager' && $user->role!='crmmanager' && $user->role!='customer') {
                                                  $output.='<tr>
