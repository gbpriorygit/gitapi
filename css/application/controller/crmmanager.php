...
if($_SESSION['role']!='crmmanager') { header('Location:'.URL); return; };
/**
 * //echo '[ PDO DEBUG ]: ' . Helper::debugPDO($sql, $parameters);  exit(); debug sql
 */
class crmmanager extends Controller
{
    ...
    public function call_log(){
      ...
      require APP . 'view/crmmanager/header.php';
      require APP . 'view/crmmanager/call_log.php';
      require APP . 'view/crmmanager/footer.php';
    }

    public function links($link){
      require APP . 'view/crmmanager/header.php';
      require APP . 'view/crmmanager/links/'.$link.'.php';
      require APP . 'view/crmmanager/footer.php';
    }
    function leads(){
        ...
        //  foreach ($all_ids as $key => $value) {
          ...
          return;
   		  ...
   		  require APP . 'view/crmmanager/header.php';
        require APP . 'view/crmmanager/leads.php';
        require APP . 'view/crmmanager/footer.php';
    }
    ...
    function recycle(){
        ...
        $operators=$this->model->getUsersByRole('operator');
        $operators=array_merge($operators,$this->model->getUsersByRole('result'));
        $operatorsR=$this->model->getUsersByRole('operator');
        ...
        //  foreach ($all_ids as $key => $value) {
          ...
          return;
   		  ...
   		  require APP . 'view/crmmanager/header.php';
        require APP . 'view/crmmanager/recycle.php';
        require APP . 'view/crmmanager/footer.php';
    }
    ...
    public function createLead(){
        ...
        require APP . 'view/crmmanager/header.php';
        require APP . 'view/crmmanager/createLead.php';
        require APP . 'view/crmmanager/footer.php';
    }
    ...
    public function editLead($lead_id){
        ...
        $statuses=$this->model->getStatuses();
        require APP . 'view/crmmanager/header.php';
        require APP . 'view/crmmanager/editLead.php';
        require APP . 'view/crmmanager/footer.php';
    }
    ...
    public function reminders(){
      ...
      require APP . 'view/crmmanager/header.php';
      require APP . 'view/crmmanager/reminders.php';
      require APP . 'view/crmmanager/footer.php';
    }
    ...
    public function viewLead($lead_id){
        ...
        //$campaigns=$this->model->getCampaigns();
        require APP . 'view/crmmanager/header.php';
        require APP . 'view/crmmanager/viewLead.php';
        require APP . 'view/crmmanager/footer.php';
    }
    ...
    public function calendar(){
      //$tasks        =  $this->model->getAllTasksAdmin();
      require APP . 'view/crmmanager/header.php';
      require APP . 'view/crmmanager/calendar.php';
      require APP . 'view/crmmanager/footer.php';
    }

    public function agenda(){
      require APP . 'view/crmmanager/header.php';
      require APP . 'view/crmmanager/agenda.php';
      require APP . 'view/crmmanager/footer.php';
    }
    ...
    public function result($showHours=false,$date=null){
            ...
            require APP . 'view/crmmanager/header.php';
            require APP . 'view/crmmanager/result.php';
            require APP . 'view/crmmanager/footer.php';
    }
    ...
    public function activity(){
      ...
      //$tasks        =  $this->model->getAllTasksAdmin();
      require APP . 'view/crmmanager/header.php';
      require APP . 'view/crmmanager/activity.php';
      require APP . 'view/crmmanager/footer.php';
    }
    ...
    public function profile(){
      require APP . 'view/crmmanager/header.php';
      require APP . 'view/crmmanager/profile.php';
      require APP . 'view/crmmanager/footer.php';
    }
    ...
    public function users($showHours=false,$date=null){
        if ($showHours=='workhours') {
            ...
            require APP . 'view/crmmanager/header.php';
            require APP . 'view/crmmanager/workhours.php';
            require APP . 'view/crmmanager/footer.php';
            return;
        }elseif(!$showHours){
            $users=$this->model->getUsersByRole('customer');
            ...
            require APP . 'view/crmmanager/header.php';
            require APP . 'view/crmmanager/users.php';
            require APP . 'view/crmmanager/footer.php';
    ...
    public function viewUser($user_id){
        ...
        require APP . 'view/crmmanager/header.php';
        require APP . 'view/crmmanager/viewUser.php';
        require APP . 'view/crmmanager/footer.php';
    ...
    public function createUser(){
        ...
        require APP . 'view/crmmanager/header.php';
        require APP . 'view/crmmanager/createUser.php';
        require APP . 'view/crmmanager/footer.php';
    }
    ...
    public function editUser($user_id){
        ...
        if(!isset($user->user_id)){
            ...
            require APP . 'view/crmmanager/editUser.php';
        }
        require APP . 'view/crmmanager/footer.php';
    }
    ...
    public function lists(){
      if (isset($_GET['deleteList'])) {
            ...
            require APP . 'view/crmmanager/header.php';
            require APP . 'view/crmmanager/lists.php';
            require APP . 'view/crmmanager/footer.php';
    }
    ...
    public function createList(){
        ...
        require APP . 'view/crmmanager/header.php';
        require APP . 'view/crmmanager/createList.php';
        require APP . 'view/crmmanager/footer.php';
    }
    public function uploadLeads($list_id){
        ...
        require APP . 'view/crmmanager/header.php';
        require APP . 'view/crmmanager/uploadLeads.php';
        require APP . 'view/crmmanager/footer.php';
    }
////////////////////////////////////////////////////////
    ...
    public function statuses(){
            $statuses=$this->model->getStatuses();
            require APP . 'view/crmmanager/header.php';
            require APP . 'view/crmmanager/statuses.php';
            require APP . 'view/crmmanager/footer.php';
    }
    ...
    public function createStatus(){
        ...
        require APP . 'view/crmmanager/header.php';
        require APP . 'view/crmmanager/createStatus.php';
        require APP . 'view/crmmanager/footer.php';
    }
    ...
    public function editStatus($status_id){
        ...
        if(!isset($status->status_id)){
            ...
            require APP . 'view/crmmanager/editStatus.php';
        }
        require APP . 'view/crmmanager/footer.php';
    }
//////////////////////////////////////////////////////////////
    ...
    public function editCampaign($campaign_id){
        ...
        if(!isset($campaign->campaign_id)){
            ...
            require APP . 'view/crmmanager/editCampaign.php';
        }
        require APP . 'view/crmmanager/footer.php';
    }
//////////////////////////////////////////////////////////////
