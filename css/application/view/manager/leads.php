...
<!--                                            </th>-->
                                            ...
                                            <th><strong>Assigned To</strong></br>
                                                ...
                                                <select data-placeholder=" "  class="cho" multiple name="assigned_to[]" id="assigned_to">
                                                    ...
                                                    <?php
                                                    $output='';
                                                    echo '<option value="0">None | '.$this->model->countBy('0', $status,$source).'</option>';
                                                    foreach ($operators as $operator) {
                                                        $output.='<option value="'.$operator->user_id.'" >'.$operator->username.' | '.$this->model->countBy($operator->user_id,$status,$source).'</option>';
                                                    }
                                                    echo $output;
                                                    ?>
                                                </select>
